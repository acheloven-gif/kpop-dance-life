...
export const FatigueIcon: React.FC<IconProps> = ({ size = 48, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
    <path d="M28 8L16 26H24L20 40L32 22H24L28 8Z" stroke="#FF69B4" strokeWidth="3" strokeLinejoin="round" fill="none" />
  </svg>
);
...
export const TrainIcon: React.FC<IconProps> = ({ size = 48, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
    <rect x="6" y="20" width="5" height="8" stroke="currentColor" strokeWidth="3" />
    <rect x="37" y="20" width="5" height="8" stroke="currentColor" strokeWidth="3" />
    <path d="M11 24H37" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
    <path d="M14 21V27M34 21V27" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
  </svg>
);
...
export const RestIcon: React.FC<IconProps> = ({ size = 48, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
    <path d="M24 8C14 8 6 14 6 22H42C42 14 34 8 24 8Z" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    <path d="M24 8V44M32 38L24 44L16 38" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M15 14C15 14 18 20 24 20C30 20 33 14 33 14" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
  </svg>
);
...
export const RestartIcon: React.FC<IconProps> = ({ size = 48, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
    <path d="M38 24C38 31.7 31.7 38 24 38C16.3 38 10 31.7 10 24C10 16.3 16.3 10 24 10C28.5 10 32.5 12 35 15" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
    <path d="M35 8V16H27" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export const SpeedIcon: React.FC<IconProps> = ({ size = 48, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
    <path d="M10 12L26 24L10 36V12Z" stroke="currentColor" strokeWidth="3" strokeLinejoin="round" fill="none" />
    <path d="M26 12L42 24L26 36V12Z" stroke="currentColor" strokeWidth="3" strokeLinejoin="round" fill="none" />
  </svg>
);
...
// Маленькие блёстки / спарклы для кнопок тренировок
export const SparklesIcon: React.FC<IconProps> = ({ size = 48, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path d="M12 2L13.5 6.5L18 8L13.5 9.5L12 14L10.5 9.5L6 8L10.5 6.5L12 2Z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M4 14L5 15.5L6.5 16L5 16.5L4 18L3 16.5L1.5 16L3 15.5L4 14Z" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
// Dumbbell icon from lucide-react
export const DumbbellIcon: React.FC<IconProps> = ({ size = 48, className = '' }) => (
  <LucideDumbbell size={size} className={className} />
);
